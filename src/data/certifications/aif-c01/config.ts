...
const aifC01: CertificationConfig = {
  id: 'aif-c01',
  name: 'AWS Certified AI Practitioner',
  code: 'AIF-C01',
  description: 'Validate your knowledge of AI/ML concepts, generative AI, and responsible AI on AWS',
  icon: '🎓',
  color: 'aws-orange',
  domains: [
    {
  ...
  examConfig: {
    ...
    passingScore: 70,
    domainWeights: { 1: 13, 2: 16, 3: 18, 4: 9, 5: 9 },
  },
};
